---
title: Typesense
description: Production-ready Typesense search engine with automated scaling and enterprise reliability. Deploy and manage with zero infrastructure hassle.
---
...
Our Typesense implementation comes with carefully tuned defaults that diverge from the [standard Typesense configuration](https://typesense.org/docs/27.1/api/server-configuration.html#using-command-line-arguments):
...
- Example: `node-stable-1.db.typesenseha.zerops`, `node-stable-2.db.typesenseha.zerops`
